...
#elif defined(RADIO_SX127X) || defined(RADIO_SX126X) || defined(RADIO_LR1121) || defined(RADIO_LR2021)
...
#endif
#else
#error "Either RADIO_SX127X, RADIO_SX126X, RADIO_SX128X, RADIO_LR1121 or RADIO_LR2021 must be defined!"
#endif
