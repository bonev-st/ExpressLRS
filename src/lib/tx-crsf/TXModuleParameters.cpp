...
// Option i is table row RATE_MAX - 1 - i, so 150Hz (row 6, the last) comes first
#define STR_LUA_PACKETRATES \
    "150Hz(-112dBm);D50Hz(-112dBm);25Hz(-123dBm);50Hz(-120dBm);100Hz(-117dBm);100Hz Full(-112dBm);200Hz(-112dBm)"
